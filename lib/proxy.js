...
const PodiumProxy = class PodiumProxy {
    constructor({
        ...
        this.proxy.on('proxyReq', (proxyReq, req, res) => {
            ...
            delete res.locals.podlet;
            delete res.locals.proxy;
        });

        this.proxy.on('proxyRes', (proxyReq, req) => {
            const end = timers.get(req);
            end();
        });
    ...
    middleware() {
        return (req, res, next) => {
            ...
            if (match) {
                ...
                res.locals.proxy = params.podiumProxyName;
                res.locals.podlet = params.podiumPodletName;
